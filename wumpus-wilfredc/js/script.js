...
window.onload = function()
{
	...
	*/
	...
	var reinciavariables = function()
	{
		...
		numFlechas = 1; //La cantidad de fechas disponibles...
	...
	function percePersonaje()
	{
		...
		*/
		...
		if(muere == 0)
		{
			...
			{
				audios("sounds/wvientohedorw.mp3");
				estilo = "viento_hedor";
